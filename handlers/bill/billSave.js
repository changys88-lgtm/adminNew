...
module.exports = async (req, res) => {
    ...
    if (mode === "input" || mode === "modify") {
        if (AccountCode) {
            ...
            titleData = `<i class="fas fa-edit search-title-text"> 계정코드 <span class='font13'>(${row.AccountCode || ''}) </span></i>`;
            htmlData  = `
                <form name="frmDetail" id="frmDetail" method="post" action="/site/site_save" enctype="multipart/form-data">
                    ...
                    <div class="row w-90 p-3">
                        ...
                        <table class="table regis-hotel">
                            <tr>
                                <th class="" style="width:130px;" required>계정 코드  </th>
                                <td class="">
                                    <input name="AccountCode" class=" wh400" type="text" ${readOnly} value="${row.AccountCode || ''}" >&nbsp;&nbsp;
                                </td>
                            </tr>
                            <tr>
                                <th class="" >계 정 명</th>
                                <td class=""><input name="AccountName" type="text"  class="" value="${row.AccountName || ''}"></td>
                            </tr>
                            <tr>
                                <th class="" >계정 설명</th>
                                <td class=""><input name="AccountIntro" type="text"  class="" value="${row.AccountIntro || ''}"></td>
                            </tr>
                            <tr>
                                <th class="" >구 분</th>
                                <td class="">
                            ...
                            <tr>
                                <th class="" >정렬순서</td>
                                <td class=""><input name="orderby" type="text"  class="" value="${row.orderby || ''}"></td>
                            </tr>
                        </table>
                        </div>
                    </div>
