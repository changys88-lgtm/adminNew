...
if ($mode == "modify" and $uid != "") {
	$sql = "select * from tblFaq where uid = '$uid' ";
...
<div class="pop" style="width:100%">
  <h1 class="pop_top">FAQ 등록및 수정</h1>


		<form name="frmForm" action="../bbs/faq_save.php" enctype="multipart/form-data" method="post">
			...
			<tr>
				...
				<td >
					<select name="sGubun">
						<option value=''>선택하세요
						<?
						foreach ($arrayFaqGubun as $key => $val) {
		...
		<textarea name="ir1" id="ir1" rows="10" cols="100" style="width:650px; height:350px; display:;"></textarea>
				</td>
			</tr>
			<tr>
...
<? include "../include/bottom_pop.php"; ?>
